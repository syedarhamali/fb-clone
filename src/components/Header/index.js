    ...
    return (
        <header>
            <div className="header-child">
                ...
                <img className='sm-brand' width={'120px'} src='https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Facebook_Logo_%282019%29.svg/1024px-Facebook_Logo_%282019%29.svg.png'alt='logo'/>
